...
class Tests {
    ...
    fun circleByThreePoints() {
        val testResult = circleByThreePoints(Point(1.0, -10.0), Point(-2.0, 0.0), Point(-10.0, 0.0))
        assertTrue(testResult.center.distance(Point(0.0, 0.0)) < 1e-5)
        assertEquals(5.0, testResult.radius, 1e-5)
